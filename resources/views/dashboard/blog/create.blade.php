    ...
    <div class="col-lg-8 mb-5">
        <form method="POST" action="/dashboard/blog" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="title" class="form-control @error("title") is-invalid @enderror" id="title" name="title" required autofocus value="{{ old("title") }}">
              @error('title')
